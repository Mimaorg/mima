...
namespace WebApplication1.Controllers
{
    public class BillingController : Controller
    {
        ...
        public ActionResult UnVerifiedBillsV() {
            ...
            bool islimitfullfill = false;
            List<BillLimit> bl = db.BillLimits.ToList();
            var bills = db.sp_BillingsUVList_ORDER_BY_desc().ToList();
            if (db.sp_BillingsUVList_ORDER_BY_desc().ToList().Count()  == bl[0].limit)
            {
                islimitfullfill = true;
            }
            ...
            ViewBag.isLimitFullfill = islimitfullfill;
            return View(bills);
        }
