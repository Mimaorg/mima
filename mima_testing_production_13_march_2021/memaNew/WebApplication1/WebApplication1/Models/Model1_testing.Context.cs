...
namespace WebApplication1.Models
{
    ...
    public partial class Testing_Mima_Finance_Entities : DbContext
    {
        public Testing_Mima_Finance_Entities()
            : base("name=Testing_Mima_Finance_Entities")
        {
        }
        ...
        [DbFunction("Testing_Mima_Finance_Entities", "fn_ParseString")]
        public virtual IQueryable<string> fn_ParseString(string cSVString, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[Testing_Mima_Finance_Entities].[fn_ParseString](@CSVString, @Delimiter)", cSVStringParameter, delimiterParameter);
        }
