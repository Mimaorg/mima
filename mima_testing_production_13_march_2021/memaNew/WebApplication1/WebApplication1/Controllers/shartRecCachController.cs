...
//            _document.Add(jpg);
        ...
        public void ReportBody(CashReceiptVoucher data)
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 12f, 1);
            _PdfCell = new PdfPCell(new Phrase("Prepared: ________", _fontStyle));
            _PdfCell.Border = 0;
            _PdfCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _table4.AddCell(_PdfCell);

            _fontStyle = FontFactory.GetFont("Tahoma", 12f, 1);
            _PdfCell = new PdfPCell(new Phrase("Approval: ________", _fontStyle));
            _PdfCell.Border = 0;
            _PdfCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _table4.AddCell(_PdfCell);

            _fontStyle = FontFactory.GetFont("Tahoma", 12f, 1);
            _PdfCell = new PdfPCell(new Phrase("Posted: ________", _fontStyle));
            //_PdfCell.Colspan = 2;
            // _PdfCell.Width = 2;
            _PdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfCell.Border = 0;
            ...
            _PdfCell = new PdfPCell(new Phrase("Received: ________", _fontStyle));
            _PdfCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            _PdfCell.Border = 0;
            //_PdfCell.Width = 2;
            _table4.AddCell(_PdfCell);
