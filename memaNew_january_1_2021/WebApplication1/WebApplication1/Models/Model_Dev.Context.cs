...
namespace WebApplication1.Models
{
    ...
    public partial class Mima_Finance_DevEntities : DbContext
    {
        ...
        public virtual IQueryable<fn_ParseString_Result> fn_ParseString(string cSVString, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ParseString_Result>("[Mima_Finance_DevEntities].[fn_ParseString](@CSVString, @Delimiter)", cSVStringParameter, delimiterParameter);
        }
