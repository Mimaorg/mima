...
namespace WebApplication1.Models
{
    ...
    public partial class Mima_Finance_Entities : DbContext
    {
        ...
        public virtual IQueryable<fn_ParseString_Result> fn_ParseString(string cSVString, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ParseString_Result>("[Mima_Finance_Entities].[fn_ParseString](@CSVString, @Delimiter)", cSVStringParameter, delimiterParameter);
        }
