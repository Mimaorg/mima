...
namespace WebApplication1.Models
{
    ...
    public partial class Mima_Finance_DevEntities : DbContext
    {
        ...
        public virtual ObjectResult<Usp_APGL_Summary_Result> Usp_APGL_Summary(string contractor, string project)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Usp_APGL_Summary_Result>("Usp_APGL_Summary", contractorParameter, projectParameter);
        }
        ...
        public virtual ObjectResult<Usp_Print_Grid_Result> Usp_Print_Grid(string contractor)
        {
            var contractorParameter = contractor != null ?
                new ObjectParameter("Contractor", contractor) :
                new ObjectParameter("Contractor", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Usp_Print_Grid_Result>("Usp_Print_Grid", contractorParameter);
        }
