...
{
    public class shartingController : Controller
    {
        int _tablecolumn = 3;
        Document _document;
        Font _fontStyle;
        ...
        PdfPTable _table5 = new PdfPTable(5);
        ...
        public byte[] prepareReport(bankPaymentVoucher data)
        {
            ...
            _table3.SetWidths(new float[] { 80f, 80f, 80f, 80f, 40f, 80f, 40f, 40f, 40f, 40f });
            _table4.SetWidths(new float[] { 40f, 40f, 40f });
            _table5.SetWidths(new float[] { 40f, 40f, 40f, 40f, 40f });
        ...
        public void printTable2(bankPaymentVoucher data1)
        {
            ...
            _PdfCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _table5.AddCell(_PdfCell);
            foreach (var item in dd.Usp_APGL_Summary(data1.PaidTo, data1.Control).ToList())
